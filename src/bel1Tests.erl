...
createTree1() ->
  #fork{left = #leaf{char = $a, weight = 2}, right = #leaf{char = $b, weight = 3}, chars = [$a, $b], weight = 5}.
createTree2() ->
  #fork{left = #fork{left = #leaf{char = $a, weight = 2}, right = #leaf{char = $b, weight = 3}, chars = [$a, $b], weight = 5},
...
makeOrderedLeafList_test_ignore() ->
  ?_assertEqual([#leaf{char = $a, weight = 1}, #leaf{char = $d, weight = 2}, #leaf{char = $b, weight = 5}, #leaf{char = $e, weight = 11}],
    bel1:makeOrderedLeafList([{$b, 5}, {$d, 2}, {$e, 11}, {$a, 1}])).
